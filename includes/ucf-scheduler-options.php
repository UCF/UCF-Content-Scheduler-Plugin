<?php
/**
 * Class that handles admin options
 **/
if ( ! class_exists( 'UCF_Scheduler_Options' ) ) {
	class UCF_Scheduler_Options {
		public static
		...
		public static function settings_init() {
			register_setting( 'ucf_scheduler', self::$option_prefix . 'enabled_post_types' );

			add_settings_section(
				'ucf_scheduler_general',
				'General Settings',
				'',
				'ucf_scheduler'
			);
			...
			add_settings_field(
				...
				'Enable Post Types',
				array( 'UCF_Scheduler_Options', 'display_settings_field' ),
				'ucf_scheduler',
				'ucf_scheduler_general',
				array(
		...
		public static function add_options_page() {
			$page_title = 'UCF Scheduler Settings';
			$menu_title = 'UCF Scheduler';
			$capability = 'manage_options';
			$menu_slug  = 'ucf_scheduler';
			$callback   = array( 'UCF_Scheduler_Options', 'options_page_html' );
		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				<?php
				settings_fields( 'ucf_scheduler' );
				do_settings_sections( 'ucf_scheduler' );
				submit_button();
				?>
			</form>
		</div>
